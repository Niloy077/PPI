from ppiformer.utils.api import download_from_zenodo #first edit to the code
download_from_zenodo('.pyg_dataset_cache.zip')

from ppiformer.utils.api import download_from_zenodo #second edit to the code
